...
const mockUser = {
  ...
  id: 'f8fdbd3d-97fa-4d81-8633-5dbe8fa34cb9',
  password: 'password'
};
...
const { data: instruments } = await supabase.from("users").select('id, email, subscriptions (id, monthly_price, status)');
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div>
                  <div className="space-y-3">
                    ...
                    <dialog 
                      closedby="any"
                      className="m-auto fixed inset-0 rounded-xl" 
                      ref={dialogRef} 
                      style={{
                        zIndex: "var(--layer-important)"
                      }}
                    >
                      <header className="text-center py-5 border-b-1">
                        <button
                          onClick={() => {
                        console.log('Close dialog header button clicked');
                        dialogRef.current.close();
                      }} 
                          className="border-none float-right mr-4"
                        >
                          &#10006;
                        </button>
